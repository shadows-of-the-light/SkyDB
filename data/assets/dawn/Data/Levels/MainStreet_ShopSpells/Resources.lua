...
-- Prefabs
resource "LevelObjects" "BlobPrefab_MainStreetShop_Cape" { level = "MainStreetShop_Cape", source = "BlobPrefabs/MainStreetShop_Cape/Objects.level", sourcesCount = 1, sources = { "BlobPrefabs/MainStreetShop_Cape/Objects.level" }, stripDebug = true }
resource "LevelObjects" "BlobPrefab_MainStreetShop_Hair" { level = "MainStreetShop_Hair", source = "BlobPrefabs/MainStreetShop_Hair/Objects.level", sourcesCount = 1, sources = { "BlobPrefabs/MainStreetShop_Hair/Objects.level" }, stripDebug = true }
...
resource "LevelObjects" "BlobPrefab_MainStreetShop_IAP_02" { level = "MainStreetShop_IAP_02", source = "BlobPrefabs/MainStreetShop_IAP_02/Objects.level", sourcesCount = 1, sources = { "BlobPrefabs/MainStreetShop_IAP_02/Objects.level" }, stripDebug = true }
...
resource "Mesh" "BasecampHangingCloth_02" { source = "BasecampHangingCloth_02.fbx", computeOcclusions = false, computeEdges = false, computeAdjacency = false, compressPositions = false, compressUvs = false, stripUv13 = false, stripNormals = false, forceIndex32 = false, registerCollision = true, stripAnimation = false }
