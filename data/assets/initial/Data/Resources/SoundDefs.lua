...
resource "FmodStudioFile" "FmodStudioMusicAP21" { source = "Music_AP21.bank", bundle = "audioExtra" }
resource "FmodStudioFile" "FmodStudioMusicAP21Assets" { source = "Music_AP21.assets.bank", bundle = "audioExtra" }
resource "FmodStudioFile" "FmodStudioMusicAP21Streams" { source = "Music_AP21.streams.bank", bundle = "audioExtra" }
