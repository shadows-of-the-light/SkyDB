...
-- Level objects
resource "LevelObjects" "DayEnd" { level = "DayEnd", source = "Levels/DayEnd/Objects.level", sourcesCount = 9, sources = { "Levels/DayEnd/Objects.level", "Levels/DayEnd/Background.level", "Levels/DayEnd/Candle.level", "Levels/DayEnd/CapeUpgrade.level", "Levels/DayEnd/LocatedAudioSources.level", "Levels/DayEnd/Marketing_VideoFootage.level", "Levels/DayEnd/PauseCams.level", "Levels/DayEnd/SkyArtBook_Logic.level", "Levels/DayEnd/WingBuff.level" }, stripDebug = true }
